...
| <a name="input_gke_preemptible_nodes"></a> [gke\_preemptible\_nodes](#input\_gke\_preemptible\_nodes) | Whether or not GKE nodes should be deployed as preemptible | `bool` | `false` | no |
